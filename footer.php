...
<body>
    ...
    <footer class="bg-black text-white pb-5 pt-4 fixed">

        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase text-warning mb-4">Buy Cloth</h5>
                    <p>Here we are the Buy Cloth.lk&trade; to support you for accomplish your dessire by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy; 2024 Buy Cloth All Rights Reserved.</p>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-fill"></i> Panadura, Colombo 10, Sri Lanka</p>
                    <p><i class="bi bi-at"></i> Buy Cloth@gmail.com</p>
                    <p><i class="bi bi-telephone-fill"></i> +94 112 356 456</p>
                    <p><i class="bi bi-printer-fill"></i> +94 112 356 467</p>
