...
function brandReg() {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 & request.status == 200) {
            ...
            if (response == "Success") {
                document.getElementById("msg1").innerHTML = "Brand Registeration Successfully";
                document.getElementById("msg1").className = "alert alert-success";
                document.getElementById("msgDiv1").className = "d-block";
                brand.value = "";
            } else {
...
function catogaryReg() {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 & request.status == 200) {
            ...
            if (response == "Success") {
                document.getElementById("msg2").innerHTML = "Catogary Registeration Successfully";
    ...
    request.open("POST", "catogaryRegisterProcess.php", true);
    request.send(f);
}
...
function colorReg() {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 & request.status == 200) {
            ...
            if (response == "Success") {
                document.getElementById("msg3").innerHTML = "Color Registeration Successfully";
...
function sizeReg() {
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 & request.status == 200) {
            ...
            if (response == "Success") {
                document.getElementById("msg4").innerHTML = "Size Registeration Successfully";
...
function regProduct() {
    ...
    f.append("b", brand.value);
    f.append("c", catogary.value);
    f.append("co", color.value);
    f.append("s", size.value);
    f.append("d", description.value);
    f.append("i", imageUploder.files[0]);
    ...
    request.onreadystatechange = function () {
        if (request.readyState == 4 & request.status == 200) {
            var response = request.responseText;
            if (response == "Success") {
                alert("Product Registeration Successfully");
                location.reload();
            } else {
                alert(response);
...
function printDiv() {
    var orginelContent = document.body.innerHTML;
    ...
    document.body.innerHTML = orginelContent;
}
...
function addtoCart(x) {
    ...
    if (qty.value > 0) {
        ...
        swal("Oops!", "Plaease Enter Valid Quantity!", "error");
    ...
    payhere.onCompleted = function onCompleted(orderId) {
        ...
        request.onreadystatechange = function () {
            if (request.readyState == 4 & request.status == 200) {
                var response = request.responseText;
                //alert(response);
                swal("Order Added!", response, "success");
    ...
    if (email.value != "") {
        ...
        request.onreadystatechange = function () {
            if (request.readyState == 4 & request.status == 200) {
                ...
                //alert(response);
                if (response == "Success") {
                    document.getElementById("msg").innerHTML = "Email sent! Please check your email";
                    document.getElementById("msg").className = "alert alert-success";
                    document.getElementById("msgDiv").className = "d-block";
                    email.value = "";
                } else {
        ...
        alert("Plaease Enter Your Valid Email");
