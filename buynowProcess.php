...
if (isset($_POST["payment"])) {
    ...
    $oderHistoryId = Database::$connection->insert_id;

    Database::iud("INSERT INTO `order_item` (`oi_qty`,`order_history_ohid`,`stock_id`)
    VALUES ('" . $payment["qty"] . "','" . $oderHistoryId . "','" . $payment["stock_id"] . "')");

    $rs = Database::search("SELECT * FROM `stock` WHERE `id` = '" . $payment["stock_id"] . "'");
    $d = $rs->fetch_assoc();
