...
if (empty($fname)) {
    ...
    echo ("Your Number Shoud be less thane 10 Chracters.");
} else if (empty($line1)) {
    echo ("Please Enter Your Adress Line1");
} else if (strlen($line1) > 50) {
    echo ("Your Number Shoud be less thane 50 Chracters.");
} else if (empty($line2)) {
    echo ("Please Enter Your Adress Line2");
